...
# 1. Em versões anteriores ao 5.4.1, os logs são registrados no General-#0.elog, não há informações úteis no .vec e .vci
...
# 4. Ao instalar o OMNETPP, observe os parâmetros extras no arquivo configure.ini, dado aqui no github.
